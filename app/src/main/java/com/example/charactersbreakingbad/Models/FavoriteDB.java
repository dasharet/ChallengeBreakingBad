...
public class FavoriteDB extends SQLiteOpenHelper {
    ...
    private static String DATABASE_NAME = "CharacterDB";
    private static String TABLE_NAME = "favoriteTable";
    public static String KEY_ID = "id";
    public static String ITEM_NAME = "itemTitle";
    ...
    public void insertIntoTheDatabase(String item_title, String item_image, int id, String fav_status) {
        SQLiteDatabase db;
        db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(ITEM_NAME, item_title);
